...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 83.0, 343.0, 65.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 49.0, 3.0, 128.0, 65.0 ],
					"text" : "Grainflow \nScrubber",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 147.5, 379.41525411605835, 63.0, 21.0 ],
					"text" : "route none"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 747.25, 236.5, 77.0, 21.0 ],
					"text" : "prepend send"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 735.25, 165.0, 31.0, 21.0 ],
					"text" : "t b s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 846.0, 198.0, 37.0, 21.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 747.25, 286.5, 71.0, 21.0 ],
					"text" : "pattrforward"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 735.25, 122.0, 52.0, 21.0 ],
					"text" : "zl.slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 369.0, 293.0, 63.0, 21.0 ],
					"style" : "Minimal",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 689.5, 74.0, 101.0, 18.0 ],
					"style" : "Minimal",
					"text" : "grain size",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 689.5, 45.5, 101.0, 18.0 ],
					"style" : "Minimal",
					"text" : "grain rate",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 641.5, 75.5, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 429.0, 132.0, 101.0, 18.0 ],
					"style" : "Minimal",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 252.0, 132.0, 101.0, 18.0 ],
					"style" : "Minimal",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 641.5, 47.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_exponent" : 2.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 370.5, 400.5, 28.0, 21.0 ],
					"style" : "Minimal",
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 370.5, 358.5, 39.0, 21.0 ],
					"style" : "Minimal",
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 370.5, 327.0, 70.0, 21.0 ],
					"style" : "Minimal",
					"text" : "mousestate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 417.5, 408.5, 51.0, 21.0 ],
					"style" : "Minimal",
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 417.5, 384.5, 28.0, 21.0 ],
					"style" : "Minimal",
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 417.5, 353.5, 88.0, 21.0 ],
					"style" : "Minimal",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 621.5, 400.5, 43.0, 21.0 ],
					"style" : "Minimal",
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 542.5, 400.5, 43.0, 21.0 ],
					"style" : "Minimal",
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 362.0, 132.0, 60.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 543.5, 364.5, 48.0, 21.0 ],
					"style" : "Minimal",
					"text" : "unjoin"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 189.0, 132.0, 60.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 543.5, 336.5, 80.0, 21.0 ],
					"style" : "Minimal",
					"text" : "route clicking"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 147.5, 426.5, 91.0, 21.0 ],
					"style" : "Minimal",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 147.5, 458.5, 130.0, 21.0 ],
					"style" : "Minimal",
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "dotColorSecondary", 0.1, 1, 0.1, 0.9 ], [ "dotVJitter", 0 ], [ "selection", 0, 1 ], [ "dotScale", 1 ], [ "waveformColor", 0.1, 0.1, 0.1, 1 ], [ "bgColor", 1, 1, 1, 0 ], [ "maxBufferDrawSamples", 1920 ], [ "buffername", "---grainflow" ], [ "selectColor", 1, 1, 1, 0.75 ], [ "mode", 0 ], [ "dotColor", 0.392, 1, 0.663, 1 ] ],
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 113.5, 127.5, 455.0, 121.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 189.0, 3.0, 446.0, 121.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.5, 127.5, 460.5, 123.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 186.25, 3.0, 451.5, 123.5 ],
					"rounded" : 0,
					"style" : "Minimal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 228.0, 293.0, 128.0, 128.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 553.0, 636.0, 436.166666666666686, 636.0 ],
					"source" : [ "obj-25", 0 ]
				}
