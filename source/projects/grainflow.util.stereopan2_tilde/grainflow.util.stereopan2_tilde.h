...
class grainflow_util_stereopan2_tilde : public object<grainflow_util_stereopan2_tilde>, public mc_operator<>
{
public:
...
private:
	...
	unique_ptr<gf_panner<INTERNALBLOCK>> panner_;
...
#pragma region DSP
	...
	grainflow_util_stereopan2_tilde();
	~grainflow_util_stereopan2_tilde();
