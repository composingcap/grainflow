...
#include "Grainflow.voice_tilde.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<Grainflow_voice_tilde> an_instance;
        Grainflow_voice_tilde&              my_object = an_instance;
