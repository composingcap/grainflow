...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.25, 246.0, 57.0, 20.0 ],
					"text" : "Slice max"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.791666666666686, 246.0, 57.0, 20.0 ],
					"text" : "Slice min"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 319.25, 246.0, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 200.791666666666686, 246.0, 50.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 1 ],
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.25, 321.0, 228.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 82.333333333333371, 277.0, 255.916666666666629, 22.0 ],
					"text" : "grainflow.spat.split 1 5"
				}
...
,
					"patching_rect" : [ 92.0, 446.0, 60.0, 22.0 ],
...
,
					"patching_rect" : [ 53.0, 513.0, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.25, 321.0, 220.0, 22.0 ],
					"text" : "grainflow.spat.3dspread 0.25 @center 1 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 234.0, 400.0, 544.0, 217.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 53.0, 472.5, 112.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"color" : [ 0.874509803921569, 0.250980392156863, 0.717647058823529, 1.0 ],
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 155.5, 504.5, 216.5, 504.5, 216.5, 389.0, 243.5, 389.0 ],
					"source" : [ "obj-2", 1 ]
				}
