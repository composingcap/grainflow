...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 485.0, 185.0, 151.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.0, 165.0, 66.0, 21.0 ],
					"text" : "loadmess 5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 423.0, 190.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.0, 215.0, 62.0, 21.0 ],
					"text" : "ngrains $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.833333333333314, 158.0, 150.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.833333333333314, 133.0, 78.0, 21.0 ],
					"text" : "loadmess 250"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 431.0, 162.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 273.0, 408.0, 114.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 8.0, 432.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 15.8333333333333, 368.0, 61.0, 21.0 ],
					"text" : "phasor~ 5"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.833333333333314, 446.0, 145.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.833333333333314, 408.0, 169.0, 21.0 ],
					"text" : "grainflow~ _gf.grainrecordbuf 5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 65.833333333333314, 167.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.833333333333314, 190.0, 86.0, 21.0 ],
					"text" : "travRandom $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.833333333333314, 495.0, 53.0, 21.0 ],
					"text" : "mc.dac~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 516.0, 354.0, 172.0, 21.0 ],
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 65.833333333333314, 247.5, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 65.833333333333314, 314.0, 241.0, 21.0 ],
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "triangleColor", 1, 1, 1, 1 ], [ "triangleOutColor", 1, 1, 1, 1 ], [ "selection", 0, 1 ], [ "waveformColor", 0.1, 0.1, 0.1, 1 ], [ "dotScale", 1 ], [ "maxBufferDrawSamples", 1920 ], [ "dotColor", 1, 0, 0, 0.9 ], [ "bgColor", 1, 1, 1, 0 ], [ "buffername", "_gf.grainrecordbuf" ], [ "selectColor", 1, 1, 1, 0.75 ], [ "dotColorSecondary", 0.5, 0, 0, 0.9 ], [ "dotVJitter", 0 ], [ "showTriangles", 0 ], [ "mode", 0 ] ],
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 273.0, 468.0, 400.0, 100.0 ]
				}
