...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 234.0, 132.0, 148.0, 69.0 ],
...
,
					"patching_rect" : [ 381.0, 489.0, 208.0, 59.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.5, 489.0, 86.0, 21.0 ],
					"text" : "travRandom $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 414.0, 124.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 216.0, 198.0, 351.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 181.5, 204.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "dotColor", 1, 0, 0, 0.9 ], [ "maxBufferDrawSamples", 1920 ], [ "dotScale", 1 ], [ "selectColor", 1, 1, 1, 0.75 ], [ "dotColorSecondary", 0.5, 0, 0, 0.9 ], [ "dotVJitter", 0 ], [ "triangleColor", 0.2, 0.2, 0.2, 1 ], [ "trackerWidth", 2 ], [ "chan", 1 ], [ "buffername", "_gflowSynthHelp" ], [ "triangleOutColor", 1, 1, 1, 1 ], [ "trackerColor", 0.9, 0.9, 0.9, 0.75 ], [ "fps", 30 ], [ "mode", 0 ], [ "showTriangles", 1 ], [ "waveformColor", 0.1, 0.1, 0.1, 1 ], [ "selection", 0, 1 ], [ "bgColor", 1, 1, 1, 1 ] ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.5, 712.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.5, 568.0, 134.0, 21.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 191.0, 292.5, 30.0, 292.5 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 390.5, 607.5, 30.0, 607.5 ],
					"source" : [ "obj-63", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 116.5, 294.0, 30.0, 294.0 ],
					"source" : [ "obj-85", 0 ]
				}
