...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 91.5, 326.0, 101.0, 31.0 ],
					"text" : "Sets the size of each grain in ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.5, 391.0, 92.0, 21.0 ],
					"text" : "s __gf.helpsynth"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 277.0, 389.0, 92.0, 21.0 ],
					"text" : "s __gf.helpsynth"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 354.5, 321.0, 57.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 277.0, 321.0, 57.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 277.0, 353.0, 45.0, 21.0 ],
					"text" : "trav $1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "By default, new parameters are triggered when a new voice is set.  If yoou use autoUpdate, the parameters on all grain will update as they change"
				}
...
,
					"patching_rect" : [ 852.0, 246.0, 68.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 205.0, 150.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "grainflow.synth~ is an implmentation of grainflow that should allow for easy creation of granular synthisizers"
				}
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "selection", 0, 1 ], [ "buffername", "_gflowSynthHelp" ], [ "dotVJitter", 0 ], [ "triangleOutColor", 1, 1, 1, 1 ], [ "maxBufferDrawSamples", 1920 ], [ "showTriangles", 1 ], [ "waveformColor", 0.1, 0.1, 0.1, 1 ], [ "selectColor", 1, 1, 1, 0.75 ], [ "dotColor", 1, 0, 0, 0.9 ], [ "bgColor", 1, 1, 1, 1 ], [ "dotColorSecondary", 0.5, 0, 0, 0.9 ], [ "dotScale", 1 ], [ "mode", 0 ], [ "triangleColor", 0.2, 0.2, 0.2, 1 ] ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.5, 529.0, 92.0, 21.0 ],
					"text" : "s __gf.helpsynth"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 257.0, 92.0, 21.0 ],
					"text" : "s __gf.helpsynth"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 26.5, 326.0, 57.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.5, 353.0, 63.0, 21.0 ],
					"text" : "period $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 9.0, 96.0, 83.0, 21.0 ],
					"text" : "notein"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.5, 440.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.5, 485.0, 134.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 209.0, 29.5, 21.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 9.0, 140.0, 336.0, 53.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 861.5, 279.5, 286.5, 279.5 ],
					"source" : [ "obj-62", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 910.5, 279.5, 364.0, 279.5 ],
					"source" : [ "obj-62", 1 ]
				}
