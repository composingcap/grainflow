...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 101.0, 363.0, 231.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 708.0, 31.0, 59.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 708.0, 6.0, 70.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 708.0, 54.0, 50.5, 36.0 ],
					"text" : "t b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 589.0, 390.0, 171.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 442.0, 283.0, 160.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 340.0, 66.0, 35.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 349.0, 90.0, 53.0, 22.0 ],
					"text" : "getnode"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.0, 203.0, 95.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.0, 213.5, 85.5, 24.0 ],
					"text" : "Strength"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 509.0, 155.0, 168.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 457.0, 118.0, 30.0, 36.0 ],
					"text" : "0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 133.0, 243.0, 66.0, 22.0 ],
					"text" : "dimop $1"
				}
...
,
					"patching_rect" : [ 338.0, 243.0, 169.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 274.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 611.0, 363.0, 113.0, 22.0 ],
					"text" : "prepend magnets"
				}
...
,
					...
					"patching_rect" : [ 611.0, 333.0, 102.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"legacy" : 1,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 157.0, 105.0, 141.0, 22.0 ],
...
,
					"patching_rect" : [ 89.0, 283.0, 90.0, 22.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Lato",
						"fontsize" : 11.0,
						"globalpatchername" : ""
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 235.0, 321.0, 167.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 54.0, 255.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 37.0, 458.0, 73.0, 22.0 ],
					"text" : "mc.*~ 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 80.0, 138.0, 54.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 37.0, 431.0, 74.0, 22.0 ],
					"text" : "mc.stereo~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 44.0, 114.0, 71.0, 22.0 ],
					"text" : "phasor~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 44.0, 165.0, 141.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 37.0, 399.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "jit_matrix" ],
					"patching_rect" : [ 69.0, 321.0, 130.0, 22.0 ],
