...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 378.0, 20.0, 40.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 238.0, 411.0, 45.0, 45.0 ]
				}
...
,
					"patching_rect" : [ 71.5, 196.0, 92.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 230.75, 330.0, 85.0, 22.0 ],
					"text" : "mc.mixdown~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 508.0, 59.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 570.0, 235.0, 57.0, 22.0 ],
					"text" : "phasor~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 111.0, 80.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 385.0, 230.0, 50.0, 74.0 ],
					"text" : "xyz 19 2.027543 -0.478733 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 433.0, 88.0, 200.0, 22.0 ],
					"text" : "translate -4. 0 0, translateRandom 2 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 426.0, 36.0, 214.0, 22.0 ],
					"text" : "translate 2. 0 0, translateRandom 0.1 0.5 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 527.0, 136.0, 130.0, 22.0 ],
					"text" : "buffer~ _gfdoppler anton"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 217.0, 36.0, 130.0, 22.0 ],
					"text" : "grainflow~ _gfdoppler 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.0, 70.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.0, 126.0, 169.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 238.0, 279.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 238.0, 174.0, 123.0, 22.0 ],
					"text" : "grainflow.spat.doppler~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 582.0, 290.0, 416.0, 166.0 ]
				}
...
, 			{
				"name" : "grainflow.spat.doppler~.maxpat",
