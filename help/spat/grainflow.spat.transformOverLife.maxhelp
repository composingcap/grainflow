...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 108.0, 150.0, 20.0 ],
					"text" : "Help file needs more work",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 195.0, 207.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.5, 299.0, 250.0, 22.0 ],
					"text" : "scale 1.5, innerRadius 1, phase 0.25, rotate -0.125"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 535.0, 359.0, 46.0, 22.0 ],
					"text" : "scale -2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 294.0, 234.0, 52.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 328.0, 359.0, 174.0, 22.0 ],
					"text" : "rotate 0.35 0 0, rotateRandom 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.5, 336.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.5, 384.0, 169.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 531.0, 61.0, 22.0 ],
					"text" : "mc.*~ 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 80.0, 144.0, 189.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 46.0, 488.0, 85.0, 22.0 ],
					"text" : "mc.mixdown~ 2"
				}
...
,
					"patching_rect" : [ 101.0, 415.0, 92.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 46.0, 561.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 46.0, 108.0, 57.0, 22.0 ],
					"text" : "phasor~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 241.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 455.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 130.0, 522.0, 365.0, 146.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 1 ],
					"midpoints" : [ 93.75, 290.0, 231.0, 290.0 ],
					"source" : [ "obj-3", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 81.0, 427.0, 55.5, 427.0 ],
					"source" : [ "obj-6", 0 ]
				}
