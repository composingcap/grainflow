...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "buffername", "_help_grainBuf1" ], [ "selection", 0, 1 ], [ "dotColorSecondary", 0.5, 0, 0, 0.9 ], [ "dotScale", 1 ], [ "bgColor", 1, 1, 1, 0 ], [ "selectColor", 1, 1, 1, 0.75 ], [ "maxBufferDrawSamples", 1920 ], [ "dotColor", 1, 0, 0, 0.9 ], [ "dotVJitter", 0 ], [ "mode", 0 ], [ "waveformColor", 0.1, 0.1, 0.1, 1 ] ],
