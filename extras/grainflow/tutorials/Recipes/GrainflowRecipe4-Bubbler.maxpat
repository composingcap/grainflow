...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 369.666666666666629, 402.0, 148.0, 52.0 ],
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.976470588235294, 1.0, 0.643137254901961, 1.0 ],
					"bubble" : 1,
					"bubbleside" : 3,
					"id" : "obj-26",
					"linecount" : 5,
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 250.0, 98.0, 79.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 108.0, 345.0, 52.0, 22.0 ],
					"text" : "mc.!-~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 192.666666666666629, 442.0, 149.0, 22.0 ],
					"text" : "mc.+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 322.666666666666629, 402.0, 40.0, 22.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 192.666666666666629, 402.0, 40.0, 22.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 192.666666666666629, 289.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 192.666666666666629, 250.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 192.666666666666629, 333.0, 64.0, 22.0 ],
					"text" : "mc.sah~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 549.0, 308.0, 216.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 528.0, 355.0, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.772549019607843, 1.0, 0.768627450980392, 1.0 ],
					"bubble" : 1,
					"id" : "obj-16",
					"linecount" : 4,
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 383.0, 222.0, 151.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 557.0, 491.0, 161.0, 38.0 ],
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.166666666666629, 333.0, 99.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 63.0, 531.0, 156.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 322.666666666666629, 304.0, 128.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 322.666666666666629, 271.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 322.666666666666629, 340.0, 64.0, 22.0 ],
					"text" : "mc.sah~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 63.0, 499.0, 484.0, 22.0 ],
					"text" : "mc.reson~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 100.0, 17.0, 17.0 ],
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 100.0, 16.0, 17.0 ],
					"proportion" : 0.39,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 259.0, 100.0, 83.0, 20.0 ],
					"text" : "Play sound "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 57.0, 17.0, 17.0 ],
					"text" : "1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 57.0, 16.0, 17.0 ],
					"proportion" : 0.39,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.0, 57.0, 255.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 11.0, 369.0, 34.0 ],
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 63.0, 90.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 98.0, 138.0, 62.0, 22.0 ],
					"text" : "phasor~ 8"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 63.0, 575.0, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 63.0, 175.0, 124.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.0, 636.0, 45.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 29.5, 156.5, 72.5, 156.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 2 ],
					"midpoints" : [ 202.166666666666629, 481.0, 382.5, 481.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 117.5, 385.0, 223.166666666666629, 385.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 162.5, 205.5, 537.5, 205.5 ],
					"source" : [ "obj-44", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 102.5, 228.5, 247.166666666666629, 228.5 ],
					"order" : 1,
					"source" : [ "obj-44", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 117.5, 214.5, 353.166666666666629, 214.5 ],
					"order" : 0,
					"source" : [ "obj-44", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.27843137254902, 0.92156862745098, 0.63921568627451, 1.0 ],
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 102.5, 227.5, 377.166666666666629, 227.5 ],
					"order" : 0,
					"source" : [ "obj-44", 2 ]
				}
