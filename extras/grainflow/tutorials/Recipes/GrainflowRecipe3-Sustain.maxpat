...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 312.0, 157.0, 150.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 427.0, 102.0, 17.0, 17.0 ],
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 427.0, 102.0, 16.0, 17.0 ],
					"proportion" : 0.39,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.0, 102.0, 121.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 114.0, 17.0, 17.0 ],
					"text" : "2",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 114.0, 16.0, 17.0 ],
					"proportion" : 0.39,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 257.0, 114.0, 83.0, 20.0 ],
					"text" : "Play sound "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 71.0, 17.0, 17.0 ],
					"text" : "1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 71.0, 16.0, 17.0 ],
					"proportion" : 0.39,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 71.0, 255.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 10.0, 369.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 332.0, 239.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 368.0, 71.0, 41.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 189.0, 64.0, 22.0 ],
					"text" : "clip 0. 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 214.0, 112.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 217.0, 157.0, 85.0, 22.0 ],
					"text" : "peakamp~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 94.666666666666657, 273.0, 62.0, 22.0 ],
					"text" : "phasor~ 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 269.0, 69.0, 22.0 ],
					"text" : "overdub $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 332.0, 269.0, 130.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 61.0, 389.0, 136.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 315.0, 120.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.0, 450.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 351.0, 140.0, 22.0 ],
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "dotVJitter", 0 ], [ "selection", 0, 1 ], [ "triangleColor", 1, 1, 1, 1 ], [ "buffername", "1207_flow_1" ], [ "mode", 0 ], [ "chan", 1 ], [ "displayRange", 0, 1 ], [ "triangleOutColor", 1, 1, 1, 1 ], [ "fps", 30 ], [ "dotScale", 1 ], [ "waveformColor", 0.808, 0.898, 0.91, 1 ], [ "trackerColor", 0.929, 0.929, 0.353, 1 ], [ "dotColorSecondary", 0.929, 0.929, 0.353, 1 ], [ "selectColor", 1, 1, 1, 0.75 ], [ "maxBufferDrawSamples", 1920 ], [ "trackerWidth", 2 ], [ "showTriangles", 0 ], [ "dotColor", 0.929, 0.929, 0.353, 1 ], [ "bgColor", 0.2, 0.2, 0.2, 1 ] ],
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 221.0, 343.0, 234.0, 98.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 27.5, 297.5, 70.5, 297.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				...
				"patcherrelativepath" : "../../../Documents/Max 8/Packages/Grainflow/jsui",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
