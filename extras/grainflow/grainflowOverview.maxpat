...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 310.0, 46.0, 270.0, 300.0 ],
									"tabs" : [ "Aviary", "grainFlowApp", "grainularReverb", "granularFMSoundscape", "granularStereoReverb", "granularSustain", "looperApp", "Reverb2" ]
								}
