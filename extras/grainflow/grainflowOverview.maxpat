...
,
					"patching_rect" : [ 467.0, -17.833333333333371, 57.0, 22.0 ],
...
, 			{
				"box" : 				{
					"id" : "obj-70",
					"items" : [ "01_Grainflow_Basics.maxpat", ",", "02_Live_Input.maxpat" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 467.0, 18.0, 178.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.0, 14.0, 99.5, 30.0 ],
					"text" : "Tutorials:",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 4.0, 336.0, 50.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 556.0, 50.0, 690.25, 50.0, 690.25, -28.833333333333371, 476.5, -28.833333333333371 ],
					"source" : [ "obj-70", 1 ]
				}
