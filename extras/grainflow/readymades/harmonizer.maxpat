...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 20.0, 16.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 264.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 209.0, 37.0, 29.5, 22.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 209.0, 5.0, 40.0, 22.0 ],
					"text" : "notein"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.0, 71.0, 628.0, 149.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1::obj-32" : [ "pitchJitter", "timeJitter", 0 ],
			"obj-1::obj-38" : [ "grainsize", "grainsize", 0 ],
			"obj-1::obj-45" : [ "timeJitter", "timeJitter", 0 ],
			"parameterbanks" : 			{
